...
package p1.a1x2.stuffBeginnersDontHaveToUnderstand;
...
public class OptimizationBlocker {
    ...
    final static long encodedVersion = 2___00000_003___2025_08_18__01L;
    //---------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    ...
    public void bo( final Object obj ){
        Herald.proclaimError( "\"OptimizationBlocker.bo( Object )\" was called -> the formal parameter is of type Object!" );
    ...
    /* String ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    /**
     * The method {@link #bo( String )} is used to block any kind of compiler optimization and to get rid of nasty '@SuppressWarnings("unused")'.
     * It is specific to given {@link String} type.
     * 
     * @param value  some String value 
     */
    public void bo( final String text ){
        if( null==text ){
            boOfNull();
        }else{
