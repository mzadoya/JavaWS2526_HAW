...
package p1.a1x2.testsForResistanceNet;
...
*/
import p1.a1x2.stuffBeginnersDontHaveToUnderstand.EnvironmentAnalyzer;
import p1.a1x2.stuffBeginnersDontHaveToUnderstand.GivenCodeVersion;
import p1.a1x2.stuffBeginnersDontHaveToUnderstand.OptimizationBlocker;
import p1.a1x2.stuffBeginnersDontHaveToUnderstand.Version;

import p1.a1x2.resistor.*;
/**
...
public class UnitTestFrameAndStarter {
    ...
    final static private long encodedVersion = 2___00002_002___2025_09_24__01L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    ...
    private static final class AnyNestedClass {}
    private static final AnyNestedClass anc = new AnyNestedClass();
    ...
    public static void runSetupBeforeAnyUnitTestStarts(){
        ...
        System.out.printf( "\n" );
        System.out.printf( "%s    <- is home of \".class\"-files\n",  UnitTestFrameAndStarter.class.getProtectionDomain().getCodeSource().getLocation().getPath() );
        System.out.printf( "%s    is running\n",                      anc.getClass().getEnclosingClass().getCanonicalName() );
        System.out.printf( "Setup respectively configuration: 3x6x0><5x1x8x5    ->  %s\n",  epsilon );
        System.out.printf( "\n\n\n\n" );
        //
        System.out.printf( "################################################################################" );
        System.out.printf( "\n" );
    ...
    public void testCircuit1(){
        ...
        for ( int resistance = 0; resistance <= 5000; resistance+=200 ){
            ...
            ob.bo( expected[ expectedIndex ] );
            expectedIndex++;
        }//for
        
        if( expectedIndex != expected.length  ||  0x360 != ob.getSignature()  )  throw new RuntimeException( "Uuuupppss, what happened here ???");
    }//method()
    ...
    public void testCircuit2(){
        ...
        if( expectedIndex != expected.length  ||  0x5185 != ob.getSignature()  )  throw new RuntimeException( "Uuuupppss, what happened here ???");
    }//method()
