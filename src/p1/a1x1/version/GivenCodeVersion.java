...
public class GivenCodeVersion implements Serializable {
    ...
    final static private long encodedGivenCodeVersion = 2___00002_010___2025_09_24__01L;    //### <<<=== !!! GIVEN CODE VERSION !!!
    //------------------------=======================---#---^^^^^-^^^---^^^^-^^-^^--^^      //#####################################
    //#############################################################################################################################
    ...
    // serial version unique ID is based on given code version !!!  This makes more sense.
