...
public class Version implements Serializable {
    ...
    final static private long encodedV2 =      2___00002_010___2023_12_20__01L; // "V2" ::= V^2 = (class) Version Version  resp. Version of the class Version
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
    //
    static {
    ...
    public String getDecodedVersion(){
        ...
        sb.append( " [#" );
        sb.append( String.format( "%02d", dailyVersion ));
        sb.append( "] )" );
        return sb.toString();
    }//method()
